...
//=================================================headerNavElem===========================================
headerNavElem.addEventListener('click', (event) => {
	const target = event.target;
	if (target.closest('.header__items-last-annexes')) {
		[...headerItemslastAnnexesElem.children].forEach((item, index) =>  {
			if (item === target.parentElement || item === target) {
	...
	if (target.closest('.header__items-last-theory')) {
		[...headerItemslastTheoryElem.children].forEach((item, index) =>  {
			if (item === target.parentElement || item === target) {
	...
	if (target.closest('.header__items-last-paktika')) {
		[...headerItemslastPaktikaElem.children].forEach((item, index) =>  {
			if (item === target.parentElement || item === target) {
...
//=================================================containeRItemsOneElem===========================================
const containeRElem = document.querySelector('.containeR');
const containeRItemsOneElem = document.querySelector('.containeR__items-one');
const containeRItemsTwoElem = document.querySelector('.containeR__items-two');
const containeRElemTwoElems = document.querySelectorAll('.containeR__elem-two');
containeRItemsOneElem.addEventListener('click', (event) => {
	const target = event.target;
	if (target.closest('.containeR__item-one')) {
		[...containeRItemsOneElem.children].forEach((item, index) => {
			if (item === target.parentElement || item === target) { 
				addActiveClass(containeRElem, index, 'containeR__elem-active-one')
			};
		});
	};
});
containeRItemsTwoElem.addEventListener('click', (event) => {
	const target = event.target;
	if (target.closest('.containeR__item-two')) {
		[...containeRItemsTwoElem.children].forEach((item, index) => {
			if (item === target.parentElement || item === target) { 
				addActiveClass(containeRElemTwoElems, index, 'containeR__elem-active-two')
			};
		});
	};
});
